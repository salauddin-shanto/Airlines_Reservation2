            ...
            <?php
                for($i=1;$i<=$total_seats;$i+=5){
                    ...
                    <div class="row py-3"> 
                        ...
                        <div class="col ">
                            <button type="button" class="btn btn-md btn-secondary size" value="<?php $_SESSION['seat_numeber']="$choose_class[0]".$i+3; ?>"> <?php echo "$choose_class[0]".$i+3 ?> </button>
                        </div>
        ...
        <div class="card position-fixed "style="width:40%"> <!-- Selected seat is covered under card -->
            <div class="card-body">
                ...
                <div class="row" style="padding-bottom:70px">
                    ...
                    <div class="col">
                        <h6>Seat Number</h6>
                        <!-- <h4> <?php echo $available_flights ;?> </h4> -->
                        <p></p>
                    </div>
